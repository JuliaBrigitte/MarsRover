...
//    println("yGrid "+ yGrid)
    ...
    var inputRover1=scala.io.StdIn.readLine()
...
//    println("direction2 "+ direction2)
    ...
    var roverMovement2=scala.io.StdIn.readLine()
/*
